...
from registro.views import inicio, UserViewSet,RegistroViewSet, planes, ConsultaViewSet, mapa, jsonmap, addenf, std, buscar_paciente, manuel, consulta, estadistica1, estadistica2
